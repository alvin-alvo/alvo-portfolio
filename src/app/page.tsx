    ...
    <main className="absolute inset-0 w-full h-full flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center space-y-2 pointer-events-none">
        ...
        <div className="flex flex-col items-center space-y-1">
          <span className="text-xs text-gray-500 tracking-[0.3em] font-mono opacity-50">AKA</span>
          <h2 className="text-3xl md:text-4xl font-bold font-space-grotesk text-white tracking-wide uppercase">
            ALVIN BINOY
          </h2>
        </div>

        {/* Rotating Role */}
        <div className="mt-4 flex items-center text-gray-400 font-mono text-sm md:text-base">
          <span>I&apos;m a </span>
          <RotatingText />
        </div>
